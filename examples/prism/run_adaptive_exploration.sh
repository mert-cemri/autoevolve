#!/bin/bash
# Run PRISM model placement evolution with full adaptive exploration features
# Features enabled:
...
# Default values
OUTPUT_DIR="${SCRIPT_DIR}/output_adaptive_exploration_full_v3"
ITERATIONS=20
CHECKPOINT=""
...
echo "=============================================="
echo "PRISM Model Placement - Adaptive Exploration (Full)"
echo "=============================================="
echo "Config: ${SCRIPT_DIR}/config_adaptive_exploration_full.yaml"
...
python openevolve-run.py \
    ...
    --config "${SCRIPT_DIR}/config_adaptive_exploration_full.yaml" \
    --output "${OUTPUT_DIR}" \
