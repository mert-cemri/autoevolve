    ...
    try:
        ...
        try:
            ...
            if not shape_valid:
                ...
                return {"validity": 0.0, "eval_time": float(eval_time), "error": "Invalid shapes"}
            ...
            eval_time = time.time() - start_time
            return {"validity": 0.0, "combined_score": 0.0, "eval_time": float(eval_time), "error": "Timeout"}
        except Exception as e:
            print(f"Stage 1 evaluation failed: {e}")
            print(traceback.format_exc())
            eval_time = time.time() - start_time
            return {"validity": 0.0, "combined_score": 0.0, "eval_time": float(eval_time), "error": str(e)}
